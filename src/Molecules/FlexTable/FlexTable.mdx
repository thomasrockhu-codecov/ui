...
**NOTE: For some reason if Flextable is wrapped as a styled component the TypeScript validation for the id and title props breake. This is important to know because if there is a title prop then there must be an id for a11y reasons.
