...
export default function FlagHk() {
  return (
    <>
      <g transform="scale(0.70)">
        ...
        <use xlinkHref="#petal" transform="rotate(72 450,300)" />
        <use xlinkHref="#petal" transform="rotate(144 450,300)" />
        <use xlinkHref="#petal" transform="rotate(216 450,300)" />
        <use xlinkHref="#petal" transform="rotate(288 450,300)" />
      </g>
