...
const Communications32: React.FC<IconProps> = (props) => {
  return (
    <IconBase {...props} width={32} height={32}>
      <path stroke="currentColor" strokeWidth={2} d="M6 13h3" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="currentColor"
      />
      <path stroke="currentColor" strokeWidth={2} d="M11.5 13h3M17 13h3" />
    </IconBase>
  );
};
