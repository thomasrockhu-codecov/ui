...
const Transportation24: React.FC<IconProps> = (props) => {
  return (
    <IconBase {...props} width={24} height={24}>
      <path
        ...
        fill="currentColor"
      />
      <path d="M20 22h-4v1h-2v-1h-4v1H8v-1H4v1H2v-1H1v-2h22v2h-1v1h-2v-1z" fill="currentColor" />
    </IconBase>
  );
};

Transportation24.displayName = 'Icon.Transportation';
