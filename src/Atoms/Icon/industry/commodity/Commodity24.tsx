...
const Commodity24: React.FC<IconProps> = (props) => {
  return (
    <IconBase {...props} width={24} height={24}>
      <path d="M12 17a2 2 0 01-2-2H8a4 4 0 004 4v-2z" fill="currentColor" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="currentColor"
      />
      <path d="M11.264 2.324l.698-.761.738.723L12 3l-.736-.676z" fill="currentColor" />
    </IconBase>
  );
};

Commodity24.displayName = 'Icon.Commodity';
