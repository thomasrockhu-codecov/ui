...
const Commodity32: React.FC<IconProps> = ({ color }) => {
  ...
  return (
    <svg width={32} height={32} fill="none">
      <path d="M16 23a3 3 0 01-3-3h-2a5 5 0 005 5v-2z" fill={iconColor} />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill={iconColor}
      />
      <path d="M16 4l.708-.706-.746-.749-.706.787L16 4z" fill={iconColor} />
    </svg>
  );
};
